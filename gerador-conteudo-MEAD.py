...
def montar_pagina_json(
    ...
    """
    Monta a estrutura oficial completa da página
    ...
    - Não chama Ollama.
    - Não gera conteúdo.
    - Não grava diretamente o arquivo.
    - Apenas organiza os dados recebidos.
    - Preserva informacoes_relevantes como LISTA DE OBJETOS.
    - Garante 5 blocos.
    - Garante 12 segmentos.
    - Garante 6 imagens.
    ...
    try:
        ...
        for numero in range(
            ...
            #
            # INFORMACOES_RELEVANTES DEVE SER SEMPRE LISTA.
            # ------------------------------------------------

            informacoes_finais = bloco_final.get(
                "informacoes_relevantes",
                []
            )
            ...
            informacoes_finais = [
                ...
                for item in informacoes_finais
        ...
        print(
            "FRAGMENTOS INFORMACOES_RELEVANTES:",
            total_fragmentos
        )
...
def montar_pagina_json(
    ...
    controle_padrao = {
        "palavra_chave": tema,
        "meta_repeticoes": 60,
        "repeticoes_realizadas": 0,
        "repeticoes_faltantes": 60
    }
    ...
    if isinstance(
        ...
        # Lista única recebida.
        # Não transforma os objetos em string.
    ...
    for campo in campos_gerais:
        ...
        # Mantém listas/dicionários quando
        # o campo precisar deles.
    ...
    for numero_bloco in range(
        ...
        # ----------------------------------------------------
        # DADOS DO BLOCO RECEBIDOS EM dados_pagina
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # INFORMAÇÕES RELEVANTES DO BLOCO
        # ----------------------------------------------------

...
def executar():
    ...
    # ============================================================
    #
    # Identifica a empresa/marca realmente mencionada no conteúdo
    # da fonte.
    #
    # REGRAS:
    # - Não inventar empresa.
    # - Não considerar automaticamente o domínio como empresa.
    # - O domínio é preservado apenas como informação da fonte.
    # - Priorizar identificações explícitas no texto.
    # - Aceitar construções naturais como:
    #
    ...
    #
    # - Retornar sempre a mesma estrutura.
    #
    # IMPORTANTE:
    # Esta função deve permanecer em ESCOPO GLOBAL.
    # NÃO colocar dentro de gerar_e_salvar_mapa_mead().
    # ============================================================
    ...
    def identificar_empresa_fonte(
        ...
        """
        Identifica de forma conservadora a empresa/marca
        explicitamente mencionada no conteúdo da fonte.
    
        Não utiliza o domínio para inventar uma empresa.
        ...
        # ========================================================
        # 02. NORMALIZAR TEXTO PARA ANÁLISE
        # ========================================================
        ...
        # ========================================================
        # 03. PADRÕES DE IDENTIFICAÇÃO EXPLÍCITA
        # ========================================================
        #
        # Estes são os casos de maior confiança.
        # ========================================================
        ...
        # ========================================================
        # 04. EXECUTAR PADRÕES EXPLÍCITOS
        # ========================================================
        ...
        for padrao in padroes_explicitos:
            ...
            # Evita capturar textos excessivamente longos.
            if len(nome) > 120:
        ...
        # ========================================================
        # 05. EMPRESA APRESENTADA COMO SUJEITO DA FRASE
        # ========================================================
        #
        # Exemplos:
        #
        ...
        #
        # O nome precisa começar com maiúscula e ser seguido
        # por uma construção típica de apresentação empresarial.
        # ========================================================
        ...
        for padrao in padroes_apresentacao:
            ...
            # ----------------------------------------------------
            # Evitar nomes obviamente genéricos
            # ----------------------------------------------------
        ...
        #   "As bombas Sanitárias BOMBINOX são..."
        #
        # Procuramos uma marca em caixa alta associada a uma
        # construção verbal que apresente ou descreva a empresa/
        # fabricante.
        #
        # Não usamos qualquer palavra em caixa alta isoladamente,
        ...
        for padrao in padroes_marca:
            ...
            # ----------------------------------------------------
            # Evitar siglas técnicas muito curtas
            # ----------------------------------------------------
        ...
        # ========================================================
        #
        # Neste caso não inventamos nada.
        # O domínio continua preservado.
        # ========================================================
